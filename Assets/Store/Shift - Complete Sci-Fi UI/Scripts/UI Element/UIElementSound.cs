...
namespace Michsky.UI.Shift
{
    ...
    public class UIElementSound : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler
    {
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            {
                if (hoverSFX == null) { Managers.Sound.Play(UIManagerAsset.hoverSound); }
                else { Managers.Sound.Play(hoverSFX); }
            }
        }
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            {
                if (clickSFX == null) { Managers.Sound.Play(UIManagerAsset.clickSound); }
                else { Managers.Sound.Play(clickSFX); }
            }
        }
    }
}